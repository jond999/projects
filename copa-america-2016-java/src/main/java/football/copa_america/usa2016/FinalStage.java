...
public class FinalStage
{
    ...
    public void init1()
    {
        ...
        try
        {
            ...
            Element game34 = games1.getChild("Game34");
            Element gameFinal = games1.getChild("GameFinal");
            
            Element teamHome34 = game34.getChild("TeamHome");
            String teamHomeId34 = teamHome34.getText();
            Element teamAway34 = game34.getChild("TeamAway");
            String teamAwayId34 = teamAway34.getText();
            ...
            if(teamHomeId34.length() == 1 && teamHomeIdFinal.length() == 1)
            {
                ...
                {                                
                    ...
                    if(goalsTeamHome > goalsTeamAway)
                    {
                        ...
                        teamHome34.setText(teamAwayGame1.getText());
                    }
                    else if(goalsTeamHome < goalsTeamAway)
                    {
                        teamHomeFinal.setText(teamAwayGame1.getText());
                        teamHome34.setText(teamHomeGame1.getText());
                    }                     
                }
                else if(Integer.parseInt(penalties) == 1)
                {
            ...
            if(teamAwayId34.length() == 1 && teamAwayIdFinal.length() == 1)
            {
                ...
                {                                
                    ...
                    if(goalsTeamHome > goalsTeamAway)
                    {
                        ...
                        teamAway34.setText(teamAwayGame2.getText());
                    }
                    else if(goalsTeamHome < goalsTeamAway)
                    {
                        teamAwayFinal.setText(teamAwayGame2.getText());
                        teamAway34.setText(teamHomeGame2.getText());
                    }                     
                }
                else if(Integer.parseInt(penalties) == 1)
                {
                    ...
                    if(penaltiesGoalsTeamHome > penaltiesGoalsTeamAway)
                    {
                        ...
                        teamHome34.setText(teamAwayGame2.getText());
                    }
                    else if(penaltiesGoalsTeamHome < penaltiesGoalsTeamAway)
                    {
                        teamHomeFinal.setText(teamAwayGame2.getText());
                        teamHome34.setText(teamHomeGame2.getText());
                    }
                }                
            }            
